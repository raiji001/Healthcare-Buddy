...
class MainForm(Frame):
    ...
    def __init__(self, master=None):
        ...
        self.createWidget()
    def createWidget(self):
        self.lblMsg=Label(self, text="Healthcare Buddy", bg="lightblue", width="280", height="2", font=("Helvetica 13 bold"))
        self.lblMsg.pack()
        ...
        self.lblTeam=Label(self, text="Dev & Trained by:", bg="khaki", width = "250", height = "1",padx=10, pady=10, font=("Helvetica", 13))
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Shivani", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Mohit Kumar", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Arpit Kamboj", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam3=Label(self, text="Vishesh Rai", bg="white", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
